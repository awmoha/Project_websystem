<div class="container mt-5">
  ...
  <div class="row mb-4 text-center" id="sortable-dashboard">
    <div class="col-md-4 mb-3" id="card1">
      <div class="card shadow-sm dashboard-card bg-primary text-white">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-3" id="card2">
      <div class="card shadow-sm dashboard-card bg-danger text-white">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-3" id="card3">
      <div class="card shadow-sm dashboard-card bg-info text-white">
        <div class="card-body">
...
<div class="row mb-4" id="sortable-tables">
    ...
    <div class="card shadow-sm dashboard-card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0" id="severityTableTable">
            <thead>
              <tr>
  ...
  <div class="col-md-6 mb-3" id="typeTable">
    <div class="card shadow-sm dashboard-card">
      <div class="card-body">
        <h5 class="card-title">Incidents by Type</h5>
        <div class="table-responsive">
          <table class="table table-hover mb-0" id="typeTableTable">
            <thead>
              <tr>
                <th>Type</th>
                <th>Count</th>
  ...
  <div class="col-md-6 mb-3" id="incidentBarChartWrapper">
    <div class="card shadow-sm dashboard-card">
      <div class="card-body">
  ...
  <div class="col-md-6 mb-3" id="incidentTypeChartWrapper">
    <div class="card shadow-sm dashboard-card">
      <div class="card-body">
        <h5 class="card-title">Incidents by Type</h5>
